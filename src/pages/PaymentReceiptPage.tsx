  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-6 sm:mb-8">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold mb-2" style={{ color: primaryColor }}>
          تم الدفع بنجاح!
        </h1>
      ...
      {/* Receipt Details */}
      <Card className="p-4 sm:p-6 mb-6" style={{ borderTop: `4px solid ${primaryColor}`, borderRadius: gatewayVisuals?.borderRadius.lg || '12px', boxShadow: gatewayVisuals?.shadows.lg || '0 4px 20px rgba(0,0,0,0.1)' }}>
