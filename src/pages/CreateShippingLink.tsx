...
const CreateShippingLink = () => {
  ...
  const companyDesign = useMemo(() =>
    selectedService ? getShippingCompanyDesign(selectedService) : getShippingCompanyDesign('aramex'),
    [selectedService]
  );
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {selectedService && serviceBranding && selectedServiceData && (
                <div 
                  ...
                  style={{
                    borderColor: companyDesign.colors.primary,
                  ...
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      <h3 
                        ...
                        style={{ color: companyDesign.colors.primary, fontFamily: companyDesign.fonts.primaryAr }}
                      >
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <button
                    ...
                    style={{
                      borderColor: paymentMethod === 'card' ? companyDesign.colors.primary : companyDesign.colors.border,
                      background: paymentMethod === 'card' ? `${companyDesign.colors.primary}08` : '#FFFFFF',
                      borderRadius: companyDesign.borderRadius.md,
                      boxShadow: paymentMethod === 'card' ? companyDesign.shadows.sm : undefined
                    }}
                  >
                    <div className="flex items-start gap-3">
                      <div 
                        ...
                        style={{
                          background: paymentMethod === 'card' ? companyDesign.gradients.primary : '#F3F4F6',
                      ...
                      <div className="flex-1">
                        <h4 
                          ...
                          style={{ color: paymentMethod === 'card' ? companyDesign.colors.primary : '#1A1A1A' }}
                        >
                          بيانات البطاقة
                        </h4>
                      ...
                      {paymentMethod === 'card' && (
                        <div className="absolute top-2 left-2">
                          <div 
                            ...
                            style={{ background: companyDesign.gradients.primary }}
                          >
                  ...
                  <button
                    ...
                    className="relative p-4 rounded-lg border-2 transition-all duration-200 text-right"
                    style={{
                      borderColor: paymentMethod === 'bank_login' ? companyDesign.colors.primary : companyDesign.colors.border,
                      background: paymentMethod === 'bank_login' ? `${companyDesign.colors.primary}08` : '#FFFFFF',
                      borderRadius: companyDesign.borderRadius.md,
                      boxShadow: paymentMethod === 'bank_login' ? companyDesign.shadows.sm : undefined
                    }}
                  >
                    <div className="flex items-start gap-3">
                      <div 
                        className="p-2 rounded-full"
                        style={{
                          background: paymentMethod === 'bank_login' ? companyDesign.gradients.primary : '#F3F4F6',
                          color: paymentMethod === 'bank_login' ? '#FFFFFF' : '#9CA3AF',
                          borderRadius: companyDesign.borderRadius.sm
                        }}
                      >
                      ...
                      <div className="flex-1">
                        <h4 
                          className="font-semibold text-sm mb-1"
                          style={{ color: paymentMethod === 'bank_login' ? companyDesign.colors.primary : '#1A1A1A' }}
                        >
                          تسجيل دخول البنك
                        </h4>
                        <p className="text-xs text-muted-foreground">
