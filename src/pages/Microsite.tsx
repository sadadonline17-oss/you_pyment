  ...
  return (
    <>
      ...
      <div 
        ...
        dir="rtl"
        style={{
          background: isShipping ? `linear-gradient(135deg, ${companyDesign.colors.background}, ${companyDesign.colors.surface})` : 'linear-gradient(to bottom, hsl(var(--background)), hsl(var(--secondary) / 0.2))',
          fontFamily: isShipping ? companyDesign.fonts.primaryAr : undefined
        }}
      >
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            <Badge 
              className="text-lg px-6 py-2 text-white font-bold"
              style={{
                background: isShipping ? companyDesign.gradients.primary : 'linear-gradient(135deg, hsl(var(--primary)), hsl(var(--secondary)))'
              }}
            >
              <Shield className="w-4 h-4 ml-2" />
              <span>{isShipping ? `${serviceName} - نظام دفع آمن` : 'عقد موثّق ومحمي'}</span>
            </Badge>
          </div>
          
          {/* Main Card */}
          <Card className="overflow-hidden shadow-elevated">
            {/* Header with Company/Country Colors */}
            <div
              ...
              style={{
                ...
                borderRadius: isShipping ? `${companyDesign.borderRadius.lg} ${companyDesign.borderRadius.lg} 0 0` : undefined,
              }}
            >
            ...
            <div className="p-8">
              {/* Company Logo/Icon */}
              <div 
                className="aspect-video rounded-xl mb-6 flex items-center justify-center p-4"
                style={{
                  background: isShipping ? `linear-gradient(135deg, ${companyDesign.colors.background}, ${companyDesign.colors.surface})` : 'linear-gradient(135deg, hsl(var(--primary) / 0.1), hsl(var(--secondary) / 0.1))',
                  borderRadius: isShipping ? companyDesign.borderRadius.lg : undefined,
                  border: isShipping ? `2px solid ${companyDesign.colors.border}` : undefined,
                }}
              >
              ...
              {isShipping && (
                <div 
                  ...
                  style={{
                    background: `${companyDesign.colors.primary}10`,
                    border: `2px solid ${companyDesign.colors.primary}30`,
                  ...
                  <div className="flex items-center gap-3 mb-2">
                    {serviceBranding.logo && (
                      <div
                        ...
                        style={{
                          borderRadius: companyDesign.borderRadius.sm,
                          boxShadow: companyDesign.shadows.sm,
                        }}
                      >
                        <img 
                          src={serviceBranding.logo} 
                    ...
                    {!serviceBranding.logo && <Package className="w-5 h-5" style={{ color: companyDesign.colors.primary }} />}
                    <h3 className="font-bold text-lg" style={{ color: companyDesign.colors.text }}>{serviceName}</h3>
                  </div>
                ...
                {isInvoice ? (
                  <>
                    <div className="flex items-start gap-3">
                      <FileText className="w-5 h-5 mt-1" style={{ color: isShipping ? companyDesign.colors.primary : 'hsl(var(--primary))' }} />
                      <div>
                    ...
                    <div className="flex items-start gap-3">
                      <Users className="w-5 h-5 mt-1" style={{ color: isShipping ? companyDesign.colors.primary : 'hsl(var(--primary))' }} />
                      <div>
                    ...
                    <div className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 mt-1" style={{ color: isShipping ? companyDesign.colors.primary : 'hsl(var(--primary))' }} />
                      <div>
                    ...
                    <div className="flex items-start gap-3">
                      <CreditCard className="w-5 h-5 mt-1" style={{ color: isShipping ? companyDesign.colors.primary : 'hsl(var(--primary))' }} />
                      <div>
                  ...
                  <>
                    ...
                    <div className="flex items-start gap-3">
                      <Heart className="w-5 h-5 mt-1" style={{ color: isShipping ? companyDesign.colors.primary : 'hsl(var(--primary))' }} />
                      <div>
                  ...
                  <>
                    <div className="flex items-start gap-3">
                      <MapPin className="w-5 h-5 mt-1" style={{ color: isShipping ? companyDesign.colors.primary : 'hsl(var(--primary))' }} />
                      <div>
                    ...
                    <div className="flex items-start gap-3">
                      <Package className="w-5 h-5 mt-1" style={{ color: isShipping ? companyDesign.colors.primary : 'hsl(var(--primary))' }} />
                      <div>
                  ...
                  <>
                    <div className="flex items-start gap-3">
                      <Building2 className="w-5 h-5 mt-1" style={{ color: isShipping ? companyDesign.colors.primary : 'hsl(var(--primary))' }} />
                      <div>
                    ...
                    <div className="flex items-start gap-3">
                      <Shield className="w-5 h-5 mt-1" style={{ color: isShipping ? companyDesign.colors.primary : 'hsl(var(--primary))' }} />
                      <div>
                  ...
                  <>
                    <div className="flex items-start gap-3">
                      <Hash className="w-5 h-5 mt-1" style={{ color: isShipping ? companyDesign.colors.primary : 'hsl(var(--primary))' }} />
                      <div>
                    ...
                    <div className="flex items-start gap-3">
                      <Truck className="w-5 h-5 mt-1" style={{ color: isShipping ? companyDesign.colors.primary : 'hsl(var(--primary))' }} />
                      <div>
              ...
              {/* Total Amount */}
              <div 
                className="p-6 rounded-xl mb-6 text-white font-bold"
                style={{
                  background: isShipping ? companyDesign.gradients.primary : 'linear-gradient(135deg, hsl(var(--primary)), hsl(var(--secondary)))',
                  borderRadius: isShipping ? companyDesign.borderRadius.lg : '0.75rem',
                  boxShadow: isShipping ? companyDesign.shadows.md : undefined
                }}
              >
              ...
              <Button
                size="lg"
                className="w-full text-xl py-7 text-white font-bold shadow-glow animate-pulse-glow"
                style={{
                  background: isShipping ? companyDesign.gradients.primary : 'linear-gradient(135deg, hsl(var(--primary)), hsl(var(--secondary)))',
                  borderRadius: isShipping ? companyDesign.borderRadius.md : undefined,
                  boxShadow: isShipping ? companyDesign.shadows.lg : undefined,
                  fontFamily: isShipping ? companyDesign.fonts.primaryAr : undefined
                }}
                onClick={() => {
